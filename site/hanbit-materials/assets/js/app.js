(() => {
  ...
  const state = { lang: chooseLanguage(), material: chooseMaterial(), inquiry:{type:'material',material:'',formGrade:'',dimensions:'',quantity:'',application:'',delivery:'',company:'',name:'',email:'',drawing:'',critical:''} };
